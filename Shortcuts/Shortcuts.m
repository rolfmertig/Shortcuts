...
Shortcuts[] :=
    ...
    Style[
          ...
          (* (*keyevent[8] *) "Cmd Alt X",  werkt niet *)
            (*keyevent[11]*) "Ctrl Q", 
            (*keyevent[9] *) "Ctrl R", 
            (*keyevent[13]*) "Ctrl H", 
    ...
    Initialization :> (
		...
		keyHelp["Cmd Alt L"]               = "Open the Shortcuts documentation page listing all extra keyboard shortcuts.";  (* MacOSX *)
		...
		keyHelp["Ctrl T"]                  = "Evaluate the user defined code written in joker.m from " <> jokerdir;
		keyHelp["Ctrl Shift J"]            = "Open the user configurable file joker.m from " <> jokerdir ;
		keyHelp["Ctrl F2"]                 = "Open $UserBaseDirectory by SystemOpen[$UserBaseDirectory]." ;
...
";
            ...
            "
(* move cell(s) down *)
	Item[	KeyEvent[\"" <> If[$OperatingSystem === "MacOSX", "j", "d"] <> "\", Modifiers -> {Command, Option}],
...
keyevent["SelectToBottom"] = keyevent[16] = 
	...
	Item[KeyEvent[\"" <> If[$OperatingSystem === "Unix", "i","/"
	...
	Item[KeyEvent[\"F2\", Modifiers -> {" <> If[ $OperatingSystem === "MacOSX",
                                                 "Command",
                                                 "Control"
                                             ] <>"}],
