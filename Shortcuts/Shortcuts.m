...
If[$VersionNumber < 9,
  ...
  If[MemberQ[{"6202-78045-64383"}, $MachineID],
...
" <> 
"
(* Delete output: Ctrl x, is a shortcut for  Delete All Output and for NotebookDelete[Cells[MessagesNotebook[]]] *)
Item[KeyEvent[\"x\", Modifiers -> {" <> If[$OperatingSystem === "MacOSX", "Command" , "Control" ] <> ", Shift}],
     FrontEndExecute[ Needs[\"Shortcuts`\"]; Shortcuts`Shortcut[\"DeleteOutputAndMessages\"] ], MenuEvaluator -> Automatic
], 
" <> 
"
